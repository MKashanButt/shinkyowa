...
@section('content')
    ...
    <p>Shinkyowa Japan is a leading auto-trading company based in Tokyo, Japan. Our expertise lies in selling high quality,
        economical used Japanese cars to more than 120 countries. We offer our clients a wide range of models and makes, all
        thoroughly inspected and maintained. Over the years, we have strengthened our processes, ensuring that our customers
        experience a smooth purchase process, flexible payment methods and swift shipping of their vehicles. All of this has
    ...
    <p>Shinkyowa Japan is one of the few Japanese automobile exporters that delivers cars to almost every country of the
        ...
        provide extremely courteous service. This is why the company has 70% repeat customers and a family of hundreds of
    ...
    <p>The 24/7 prompt customer support is one of the major reasons why customers feel comfortable in purchasing their
        desired vehicle through Shinkyowa Japan. The company ensures that the customer finds help whenever they seek it.</p>
